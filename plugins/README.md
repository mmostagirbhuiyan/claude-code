...
| [session-management](./session-management/) | Fork or move conversations to a different working directory, preserving full history | **Commands:** `/fork`, `/move`, `/sessions` - Fork, move, or list conversation sessions across directories |
